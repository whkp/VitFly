...
def argparsing():
    ...
    parser.add_argument('--model_type', type=str, default='SpatialAttentionViT', 
                       choices=['SpatialAttentionViT', 'TemporalConsistencyLSTM', 'MultiResolutionViT', 'RobustViTLSTM'],
                       help='改进模型类型')
    ...
    parser.add_argument('--checkpoint_path', type=str, 
                       default=f'/home/{uname}/ws/vitfly_ws/src/vitfly/learner/logs/improved_model_000499.pth', 
                       help='检查点路径')
